...
$\to$ **Answer: I have (1) replaced the title name with my name, (2) un-commented the animation code, and (3) run all of this code. Please note that my animination.gif is saved to the `img` folder.**
